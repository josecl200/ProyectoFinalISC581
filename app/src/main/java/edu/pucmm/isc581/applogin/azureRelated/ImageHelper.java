...
public class ImageHelper {
    ...
    public static Boolean storeImageInBlobStorage(Context ApplicationContext, Bitmap bitmap){
        try {
            ...
            String fileName = Long.toString(System.currentTimeMillis() / 1000L) + ".jpg";
